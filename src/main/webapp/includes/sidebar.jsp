...
<nav id="sidebar" class="shadow-lg" style="min-height: 100vh; width: 280px; transition: all 0.3s; z-index: 1000;">
    ...
    <ul class="list-unstyled components">
        ...
        <li class="active">
            <a href="${pageContext.request.contextPath}/dashboard"><i class="fas fa-chart-pie main-icon me-2"></i> Dashboard Global <span class="badge bg-warning text-dark ms-2" style="font-size: 0.6rem;">En construcción</span></a>
        </li>
